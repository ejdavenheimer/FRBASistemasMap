// Agregamos "type" aquí para que TypeScript no se queje
...
export const puedeCursar = (materia: Materia, historial: Materia[]): boolean => {
  ...
  // 1. Verificar cursadas necesarias (deben estar regular o aprobada)
  ...
  // 2. Verificar finales necesarios (deben estar aprobada)
