...
export const PLAN_ESTUDIOS_INICIAL: Materia[] = [
  ...
  { id: 'sistemas-organizaciones', nombre: 'Sistemas y Procesos de Negocio', anio: 1, estado: 'pendiente', requerimientos: { paraCursar: { cursadas: [], finales: [] }, paraRendir: { finales: [] } } },
  ...
  { id: 'analisis-sistemas', nombre: 'Análisis de Sistemas de Información', anio: 2, estado: 'pendiente', requerimientos: { paraCursar: { cursadas: ['sistemas-organizaciones', 'algoritmos'], finales: [] }, paraRendir: { finales: ['sistemas-organizaciones', 'algoritmos'] } } },
  ...
  { id: 'electiva-4-1', nombre: 'Electiva II (4º Año)', anio: 4, estado: 'pendiente', requerimientos: { paraCursar: { cursadas: ['diseno-sistemas'], finales: [] }, paraRendir: { finales: [] } } },
  { id: 'electiva-4-2', nombre: 'Electiva III (4º Año)', anio: 4, estado: 'pendiente', requerimientos: { paraCursar: { cursadas: ['diseno-sistemas'], finales: [] }, paraRendir: { finales: [] } } },
  ...
  { id: 'sistemas-gestion', nombre: 'Sistemas de Gestión', anio: 5, estado: 'pendiente', requerimientos: { paraCursar: { cursadas: ['admin-sistemas', 'operativa'], finales: [] }, paraRendir: { finales: [] } } },
  ...
  { id: 'proyecto-final', nombre: 'Proyecto Final', anio: 5, estado: 'pendiente', requerimientos: { paraCursar: { cursadas: ['admin-sistemas', 'redes', 'ing-calidad-sw', 'automatizacion'], finales: ['diseno-sistemas', 'comunicaciones', 'economia'] }, paraRendir: { finales: [] } } },
  { id: 'electiva-5-1', nombre: 'Electiva IV (5º Año)', anio: 5, estado: 'pendiente', requerimientos: { paraCursar: { cursadas: ['admin-sistemas'], finales: [] }, paraRendir: { finales: [] } } },
  { id: 'electiva-5-2', nombre: 'Electiva V (5º Año)', anio: 5, estado: 'pendiente', requerimientos: { paraCursar: { cursadas: ['admin-sistemas'], finales: [] }, paraRendir: { finales: [] } } },
  { id: 'electiva-5-3', nombre: 'Electiva VI (5º Año)', anio: 5, estado: 'pendiente', requerimientos: { paraCursar: { cursadas: ['admin-sistemas'], finales: [] }, paraRendir: { finales: [] } } },
  { id: 'electiva-5-4', nombre: 'Electiva VII (5º Año)', anio: 5, estado: 'pendiente', requerimientos: { paraCursar: { cursadas: ['admin-sistemas'], finales: [] }, paraRendir: { finales: [] } } },
];